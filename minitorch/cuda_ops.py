...
def _sum_practice(out: Storage, a: Storage, size: int) -> None:
    ...
    # Store the result from the first thread in the block
    if pos == 0:
        sum = 0
...
def tensor_reduce(
    ...
    def _reduce(
        ...
        ind = pos + out_index[reduce_dim] * out_pos
        orig_i = out_index[reduce_dim]
        if ind < a_shape[reduce_dim]:
